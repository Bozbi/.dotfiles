...
SINK_COLOR="%{F#ffb52a}"  # Color for the sink icon
...
SINK_BLACKLIST=(
    "alsa_output.pci-0000_38_00.1.hdmi-stereo"
)
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        ...
        echo "${MUTED_COLOR}${nickname}0%${END_COLOR}"
    else
        echo "${SINK_COLOR}${nickname}${END_COLOR}${curVol}%"
